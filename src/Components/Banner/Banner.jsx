...
const Banner = ()=> {
    return <header className={styles.header} id="banner">
        <div className={`${styles.divHeader} ${styles.headerItem}`}>
            ...
            <small className={styles.headerItem}>Altamente eficiente en la resolución de errores y problemas, demostrando una capacidad excepcional para aplicar mis conocimientos de manera efectiva</small>
